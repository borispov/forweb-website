...
function Hero() {
  return (
    <div className="pt-48 text-center noise-bg">
      ...
      <div className="pt-12">
        <button className="hover:-translate-y-1 hover:shadow-lg primary-button text-black text-4xl rounded-full shadow-md hover:shadow-lg hover:bg-primary-400 transition-all">
