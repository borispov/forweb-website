    ...
    <div className="pt-6 lg:pt-48 md:pt-32 text-center noise-bg pb-12 relative">
      ...
      <div className="pt-12">
        <Link href="#contact-form">
          <button className="
          px-20 py-6 bg-black flex justify-between gap-5 flex-row-reverse items-center mx-auto 
          text-white text-4xl font-work font-bold rounded-full shadow-md border-black border-[1px]
          hover:-translate-y-1 hover:shadow-lg hover:bg-white hover:text-black hover:border-black transition-all">
      ...
      <svg 
        className='absolute animate__animated animate__fadeInLeft left-20 top-1/2'
