...
export default function Hero() {
  ...
  return (
    <div className="pt-20 lg:pt-48 md:pt-32 text-center noise-bg pb-32 relative">
      ...
      <svg 
        className='hidden absolute overflow-hidden animate__animated animate__fadeIn lg:animate__fadeInLeft -bottom-24 lg:left-20 lg:top-1/2'
      ...
      <PinkFloydTriangleIcon className="hidden absolute overflow-hidden animate__animated animate__fadeInLeft lg:animate__fadeInUp right-3/4 -bottom-32 lg:right-40 lg:-bottom-20 w-32 z-10" />
      <FaceDivider className="absolute center-with-abs-left w-14 lg:w-16" />
    </div>
  )
}