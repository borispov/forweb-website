export const HeroSectionData = {
  ...
  subtitle_v4: "פיתוח ועיצוב אתרים שידהימו אתכם ואת הלקוחות שלכם. באחריות!",
  cta_text: "Let's Talk",
  svg_1: "assets/svgs/hero__1.svg", // it points to public folder
  svg_2: "assets/svgs/hero__2.svg",
  svg_3: "assets/svgs/hero__3.svg",
}
...
export const testimonialDta = {
  testimonial_1: `הצטערנו שלא פנינו עוד קודם. השירות, המקצועיות, המענה המהיר ומתן הסבר לכל שאלה וייעוץ - הם מעבר לכל. והכי חשוב - מחיר ותוצאות בשטח.`
}